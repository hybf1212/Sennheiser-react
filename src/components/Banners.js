        ...
        <div id='banners'>            
            <div className='banner-img position-relative'>
                ...
                <div className='banner-text position-absolute'>
                    <div><h2 className='nondrag'>MOMENTUM Series</h2></div>
                    <div><span className='nondrag'>비교할 수 없는 젠하이저 사운드</span></div>
            ...
            <div className='banner-img position-relative'>
                ...
                <div className='banner-text position-absolute'>
                    <div><h2 className='nondrag'>AMBEO Soundbar Plus</h2></div>
                    <div><span className='nondrag'>Virtual 7.1.4. 경험해보지 못했던 소리의 세계를 느껴보세요.</span></div>
                    <div className='banner-button'><a href="">자세히보기</a></div>
                </div>
            </div>
            <div className='banner-img position-relative'>
